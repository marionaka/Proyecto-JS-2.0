function Producto(nombre, precio, stock, cantidadPedida, subtotal){
    this.nombre = nombre;
    this.precio = precio;
    this.stock = stock;
...
let producto1 = new Producto("Libro", 4000, 3200, 0, 0)
let producto2 = new Producto("Ta-Te-Ti", 1500, 300, 0, 0)
let producto3 = new Producto("Remera", 2500, 350, 0, 0)
let producto4 = new Producto("Almanaque", 1800, 250, 0, 0)
let producto5 = new Producto("Autito", 2900, 380, 0, 0)
let producto6 = new Producto("Remeras", 5000, 440, 0, 0)
let producto7 = new Producto("Planificado", 1000, 600, 0, 0)
let producto8 = new Producto("Juguete", 3000, 340, 0, 0)
let producto9 = new Producto("Libros de cuentos", 7000, 280, 0, 0)
